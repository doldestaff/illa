                    ...
                    <div>
                        ...
                        <div className="relative group flex gap-2">
                            <div className="relative flex-1">
                                <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-illa-pink transition-colors" size={18} />
                                <input
                                    type="date"
                                    value={birthDate}
                            ...
                            <button
                                ...
                                className="px-4 bg-illa-pink text-white rounded-xl text-sm font-semibold disabled:opacity-40 hover:shadow-lg transition-all"
                            >
                                {savingBirthDate ? <Loader2 size={14} className="animate-spin" /> : 'Salvar'}
                            </button>
                        </div>
