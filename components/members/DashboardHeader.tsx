                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    key={sorvetesCount}
                                    className="flex items-center gap-2 px-4 py-2 rounded-[1.2rem] bg-[#E5017D]/30 border border-[#E5017D]/40 relative overflow-hidden backdrop-blur-md shadow-[0_0_15px_rgba(229,1,125,0.3)] group/sorvete cursor-pointer min-h-[3.5rem]"
                                >
                                    <div className="absolute inset-0 bg-[#E5017D]/20 blur-md group-hover/sorvete:opacity-100 transition-opacity" />

                                    <div className="w-8 h-8 rounded-full bg-[#E5017D]/40 flex items-center justify-center relative z-10">
                                        <IceCream size={16} className="text-white drop-shadow-md group-hover/sorvete:rotate-12 transition-transform" />
                                    </div>
                                    <span className="text-xl font-black text-white relative z-10 drop-shadow-sm tabular-nums">{sorvetesCount}</span>
